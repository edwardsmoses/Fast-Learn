<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Discuss.aspx.cs" Inherits="Student_Discuss" %>
            ...
            <div class="col-lg-3 collg3">
                ...
                <div class="col-lg-9">
                    ...
                    <div class="input-group-btn">
                      <asp:LinkButton CssClass="btn btn-primary" Title="Send message" runat="server" ID="btnSend" OnClick="btnSend_Click"><i class="fa fa-send fa-2x"></i></asp:LinkButton>
                    </div>
                  </div></div>
                        <!-- /.panel-body -->
                    </div>
